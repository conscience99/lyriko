...
const SignUp = ({ setToken, setUser, token }) => {
  ...
  const handleSignUp = () => {
    ...
    if (!checked) {
      ...
      fetch("https://lyriko.herokuapp.com/api/signup", {
        method: "POST",
        headers: {
          "Content-type": "application/json",
        },
        ...
        {!verifying ? (
              ...
              <div className="name-inputs">
                ...
                <div className="username">
                  <label className="form-label">
                    ...
                    {username != "" ? (
                      <FontAwesomeIcon
                        icon={usernameValid ? faCheckCircle : faTimesCircle}
              ...
              <div className="email-pass-inputs">
                ...
                <div className="password">
                  <label className="form-label">
                    ...
                    {password !== "" ? (
                      <FontAwesomeIcon
                        icon={passwordValid ? faCheckCircle : faTimesCircle}
                ...
                <div className="c-password">
                  <label className="form-label">
                    ...
                    {confirmPassword != "" ? (
                      <FontAwesomeIcon
                        icon={passwordMatch ? faCheckCircle : faTimesCircle}
          ...
          <div>
            <div className="verification_area">
              <div className="header">
                <p>Enter the code sent to {email} to complete signup.</p>
              </div>
