...
const ForgotPassword = ({ token }) => {
  ...
  const CodeVerification = () => {
    if (code.length < 1) {
      ...
      fetch("https://lyriko.herokuapp.com/api/user/acct/verify/", {
        method: "POST",
        headers: {
          "Content-type": "application/json",
        },
        ...
        <div className="name-inputs-wrapper">
          {sendingCode ? (
            <div className="name-inputs">
              <div className="username">
                <p className="f-hint">Enter the email on your account</p>
              ...
              <div className="sign-up-btn">
                <a className="btn btn-primary" onClick={() => sendCode()}>
                  Confirm
                </a>
              </div>
            </div>
          ...
          {changingPassword ? (
            <div>
              ...
              <div className="sign-up-btn">
                <a className="btn btn-primary" onClick={() => submitPassword()}>
                  Submit
                </a>
              </div>
            </div>
